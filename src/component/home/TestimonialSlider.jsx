...
const testimonials = [
  {
    ...
    image: profile,
    review:
      "Their Billboard Advertising Service Exceeded All Expectations With Outstanding Quality And Attention To Detail. It's An Essential Marketing Tool That Significantly Boosts Business Visibility And Effectively Reaches Target Audiences.",
  },
  {
    id: 2,
    name: "JOHN DOE",
  ...
  },
  {
    ...
    image: profile,
    review:
      "Amazing Experience Working With Them. Everything Was Delivered On Time And Beyond Expectations.",
  },
];

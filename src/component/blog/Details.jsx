...
const Details = () => {
  ...
  <path d="M5.2793 9.11761C5.2793 6.93681 5.2793 5.84641 5.9545 5.16881C6.6289 4.49121 7.7145 4.49121 9.8873 4.49121H12.1913C14.3633 4.49121 15.4497 4.49121 16.1249 5.16881C16.8001 5.84641 16.7993 6.93681 16.7993 9.11761V12.9736C16.7993 15.1544 16.7993 16.2448 16.1249 16.9224C15.4497 17.6 14.3633 17.6 12.1913 17.6H9.8873C7.7153 17.6 6.6289 17.6 5.9545 16.9224C5.2793 16.2448 5.2793 15.1544 5.2793 12.9736V9.11761Z" fill="#FA0000"/>
                ...
                <ul>
                    <li>Skyrocket Your Brand with Billboard Advertising</li>
                    <li>Unlock the Potential of Outdoor Marketing with Billboards</li>
                    <li>Elevate Your Business Above the Rest with Billboards</li>
                    <li>Illuminate Your Business with Billboard Brilliance</li>
                    <li>Maximize Your Reach with Billboard Advertising</li>
                    <li>Supercharge Your Business with Billboards</li>
                </ul>
                <p>Web designing in a powerful way of just n professions, however, in  passion for a our Company. We hatendency to believe the idea that sm Technology is a broad category encompassing all aspects Web designing in a powerful =</p>

      ...
      <div className="container">
        ...
        <div className="why-grid">
          ...
          {/* Right Cards */}
            ...
            <div className="stat-card white-card card-1">
              <h3>15+</h3>
              <p>Creative Campaigns Tailored To Your Brand's Voice</p>
            </div>

            <div className="stat-card white-card card-2">
              <h3>1000</h3>
              <p>Creative Campaigns Tailored To Your Brand's Voice</p>
            </div>
          ...
          {/* Bottom Left */}
          <div className="traffic-card card-3">
            <div className="traffic-icon">⊖</div>
            <p>HIGH TRAFFIC ZONE</p>
          </div>

          {/* Bottom Middle */}
          <div className="shop-card card-4">
          ...
          {/* Bottom Right */}
          <div className="stat-card white-card card-5">
            <h3>200+</h3>
            <p>Creative Campaigns Tailored To Your Brand's Voice</p>
          </div>
